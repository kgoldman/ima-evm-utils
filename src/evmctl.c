...
char *g_evmfile;  /* for export, json file name */
bool g_use_path; /* true uses the full path as the file name */
char *g_infile;		/* for signing, the input hash file */
char *g_outfile;	/* for signing, the output signature file */
